...
console.log('🚀 ~ file: graphControl.js:88 ~ chartSelectionDropdown', chartSelectionDropdown);
/*---------Marker type dom refs-----------*/
const markerSelectionDropdown = document.querySelector('#markerTypeDropdown');
console.log("🚀 ~ file: graphControl.js:98 ~ markerSelectionDropdown", markerSelectionDropdown)
/*---------Marker type dom refs-----------*/
